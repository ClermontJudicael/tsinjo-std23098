package com.tsinjo.demo.endpoint.event.consumer;

import com.tsinjo.demo.PojaGenerated;
import com.tsinjo.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.tsinjo.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.tsinjo.demo.service.event."
