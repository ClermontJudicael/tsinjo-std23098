package com.tsinjo.demo.endpoint.event.model;

import static com.tsinjo.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.tsinjo.demo.PojaGenerated;
import com.tsinjo.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.tsinjo.demo.event1";
    return "com.tsinjo.demo.event2";
  }
}
